...
_ICON_BODIES: dict[str, str] = {
    ...
    "skull": (
        ...
        'c0 .7.6 1.3 1.3 1.3h9c.7 0 1.3-.6 1.3-1.3v-3.6l1-.4c.7-.3 1.2-1 1.2-1.8'
        'v-3.3C20 6.4 16.4 3 12 3z"/>'
        '<circle cx="8.9" cy="11" r="1.9"/>'
        '<circle cx="15.1" cy="11" r="1.9"/>'
        '<path d="M10.6 15.4h2.8"/>'
        '<path d="M9.7 21v-3"/>'
        '<path d="M14.3 21v-3"/>'
    ),
    "minimize": (
